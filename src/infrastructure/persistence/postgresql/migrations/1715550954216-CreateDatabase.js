...
export class CreateDatabase1715550954216 {
    name = 'CreateDatabase1715550954216'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "games" ("id" character varying NOT NULL, "nombre" character varying NOT NULL, "descripcion" character varying NOT NULL, "precio" integer NOT NULL, "descuentoPrecio" numeric(5,2) NOT NULL, "rating" numeric(5,2) NOT NULL, "stock" integer NOT NULL, "plataforma" character varying NOT NULL, "categoria" character varying NOT NULL, "thumbnail" character varying NOT NULL, "imagen" character varying array NOT NULL, "trailer" character varying NOT NULL, CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`);
