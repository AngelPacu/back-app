...
export class CreateDatabase1715105795402 {
    name = 'CreateDatabase1715105795402'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "games" ("id" character varying NOT NULL, "nombre" character varying NOT NULL, "descripcion" character varying NOT NULL, "precio" integer NOT NULL, "trailer" character varying NOT NULL, "imagen" character varying NOT NULL, "stock" boolean NOT NULL, CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "facturas" ("id" integer NOT NULL, "fecha" TIMESTAMP NOT NULL, "tarjeta" character varying NOT NULL, "total" integer NOT NULL, "estado" character varying NOT NULL, "usersId" character varying, CONSTRAINT "PK_f302947c1e4773639b20707a8bc" PRIMARY KEY ("id"))`);
