...
export class CreateDatabase1715271322568 {
    name = 'CreateDatabase1715271322568'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "facturas" ("id" SERIAL NOT NULL, "fecha" TIMESTAMP NOT NULL, "tarjeta" character varying NOT NULL, "total" integer NOT NULL, "estado" character varying NOT NULL, "usersId" character varying, CONSTRAINT "PK_f302947c1e4773639b20707a8bc" PRIMARY KEY ("id"))`);
